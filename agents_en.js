...
- Generate JSON content with at least 10 fields to ensure the structure is complete.`;
    ...
    "url": '/webApps/document/agentList/appItem/cardList.vue',
    "className": 'ElementVueItem',
    "cardName": 'pptAppCard',
    "dsl": {
      "style": {
...
- Generate JSON content with at least 10 fields to ensure the complete structure.`;
    ...
    "jsonToFragments": function (json) {
      ...
      let testApp = {
        url: "/webApps/document/agentList/appItem/testApp.vue",
        className: "ElementVueItem",
        dsl: {
          data: {
            qMap: qMap,
      ...
      let lightedTree = {
        url: "/webApps/document/agentList/appItem/lightedTree.vue",
        className: "ElementVueItem",
        dsl: {
          data: {
            content: {
    ...
    "url": '/webApps/document/agentList/appItem/knowledgeTree.vue',
    "className": 'ElementVueItem',
...
- Generate JSON content, which contains at least 10 fields to ensure the complete structure.`;
    ...
    "dataFormat": 'json',
    "url": '/webApps/document/agentList/appItem/flashcards.vue',
    "className": 'ElementVueItem',

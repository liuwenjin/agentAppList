transweb_agents({
  agentList: [
    {
      ...
      posterApp: {
        url: "https://transweb.cn/bucket/personal/1533720062/layout/posterApp.vue",
    ...
    难度分级：[{{difficulty}}]
    题目种类：既包括基础知识题，也涵盖提升题，确保全面考查学生的语文能力。
  ...
  `;
      ...
      dsl: { style: { padding: "0px", background: "#fff" } },
    },
    {
    ...
    难度分级：[{{difficulty}}]
  题目种类：包含基础题、提高题和综合应用题，确保全面考查学生的数学能力。
    ...
    ### 技能 2: 内容生成
    - 为每个知识点，{{questionTypeInfo}} 附上正确选项极其说明。
    - 生成的内容中如果包含公式、数字或操作符号内容，用 $$...$$ 包裹块级公式， 数字、操作符号或完整的公式内容严格使用 LaTeX 语法。
  ...
  `;
    ...
    难度分级：[{{difficulty}}]
  题目种类：包含基础题、提高题和综合应用题，确保全面考查学生的英语能力。
  ...
  难度分级：[{{difficulty}}]
  题目种类：包含基础题、提高题和综合应用题，确保全面考查学生的物理能力。
  ...
  `;
    ...
    难度分级：[{{difficulty}}]
  题目种类：包含基础题、提高题和综合应用题，确保全面考查学生的化学能力。
  ...
  `;
    ...
    难度分级：[{{difficulty}}]
  题目种类：包含基础题、提高题和综合应用题，确保全面考查学生的历史知识与理解能力。
  ...
  `;
    ...
    难度分级：[{{difficulty}}]
    题目种类：包含基础题、提高题和综合应用题，确保全面考查学生的地理知识与理解能力。
  ...
  `;
    ...
    },
    {
      ...
      meta: {
        label: "道德与法治智能出题",
        description: "智能出题、专业讲解，错题变成新起点，一步步提升成绩。",
        slogan: "道德与法治备考小帮手：AI 测评与错题诊断系统",
        slogan1: "覆盖核心考点 · 提升应试技巧 · 全面巩固思想政治基础",
        buttonText: "生成初中道法题",
        confirmTips: "AI 智能生成，预计 30 秒内完成",
        scanQrTips: "扫码检测，开启你的自我成长之旅！",
        inputPlaceholder: "请输入道德与法治知识点范围描述",
      },
      posterApp: {
        url: "https://transweb.cn/bucket/personal/1533720062/layout/posterApp.vue",
        className: "ElementVueItem",
        dsl: { data: { label: "道德与法治" } },
      },
      promptMacro: {
        type: ["单选题", "多选题"],
        difficulty: "中级",
      ...
      appPrompts: function () {
        return `# 任务目标：
    你是一位专注于初中道德与法治科目出题与错题解析的AI教学助手。你的任务是根据指定的教材内容、知识点或考试大纲，为学生生成测试题，并在学生作答后，对他们答错的题目提供详细的答案解析和讲解。请严格按照以下要求执行：
    
    1. 适用范围与难度
    适用对象：初中学生，涵盖初一至初三各年级的道德与法治内容。
    难度分级：[{{difficulty}}]
    题目种类：包含基础题、提高题和综合应用题，确保全面考查学生的道德与法治素养与理解能力。

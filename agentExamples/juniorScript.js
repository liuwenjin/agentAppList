...
`;
  ...
  - 为解析的知识点列表，分别生成 5 道测试题, 包含中低难度的两道单选题、一道填空题、一道多选题和一道简答题，并附上正确选项极其说明。
	- 生成的内容中如果包含公式，用 $$...$$ 包裹块级公式， 公式内容严格使用 LaTeX 语法，确保所有符号（如小于等于符号 '\\leq'）正确解析。例如：x + 5 \\leq 12 请不要生成未解析的 'leq' 或其他未格式化的内容。
	- 包含'\\'字符时，请考虑公式在浏览器使用场景下，该字符的转义特性， 将'\\'用'\\\\'替代。
...
`;
    ...
    "meta": {
        "label": '初中思想政治智能出题',
        "description": '智能出题、专业讲解，错题变成新起点，一步步提升成绩。',
        "slogan": '初中思想政治备考小帮手：AI 测评与错题诊断系统',

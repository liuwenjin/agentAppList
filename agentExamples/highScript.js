transweb_agents({
    ...
    1. 适用范围与难度
    适用对象：高中学生，涵盖高一至高三各年级的语文内容。
    难度分级：题目难度适中，既包括基础知识题，也涵盖提升题，确保全面考查学生的语文能力。
    
    2. 知识点覆盖
    内容范围：根据指定的教材章节或知识点，如字词句的正确使用、成语运用、古诗文背诵与理解、现代文阅读与分析、作文写作技巧、文学常识等。
  ...
  ### 技能 2: 内容生成
  - 为每个知识点生成 5 道题目，{{questionTypeInfo}} ，附上正确选项极其说明。
